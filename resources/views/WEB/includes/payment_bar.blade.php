<div class="pt-4 d-flex justify-content-center" style="margin-left: 30%;">
    ...
    <div class="container">
        ...
        <div class="arrow-steps clearfix">
            ...
            @if(auth('member')->user() != null)
                ...
                <div class="step count-cart check-submit {{request()->routeIs('WEB.payment.success') ? 'current' : ''}}"> <span><a href="{{$cart==null ? route('WEB.payment.success') : '#'}}" >Thanh toán</a><span> </div>
            @else
